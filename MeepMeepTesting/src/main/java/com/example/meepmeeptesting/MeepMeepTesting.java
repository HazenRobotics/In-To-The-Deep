...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity activePath = SpecimenPush(meepMeep);
...
//                .splineToSplineHeading(new Pose2d(11,-34,Math.toRadians(90 - 1e-6)),Math.toRadians(90))//Travel to hanging bar
    ...
    public static RoadRunnerBotEntity SpecimenPush(MeepMeep meepMeep) {
        RoadRunnerBotEntity bot = new DefaultBotBuilder(meepMeep)
                // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
                .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15)
                .build();
        bot.runAction(bot.getDrive().actionBuilder(new Pose2d(9, -65, Math.toRadians(90)))
                        ...
                        .lineToY(-56)
                        .setTangent(Math.toRadians(90))
                        .splineToConstantHeading(new Vector2d(40,-45),Math.toRadians(180))
                        .waitSeconds(0.1)
                        .lineToY(-62)
