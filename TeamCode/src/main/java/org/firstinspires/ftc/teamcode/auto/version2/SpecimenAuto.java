...
public class SpecimenAuto extends LinearOpMode {
    ...
    Pose2d specimenDeposit = new Pose2d(-6,-32,Math.toRadians(90));
...
//                        //Intake Spec 1
                        ...
                        .setReversed(true)
                        .strafeToLinearHeading(intakePose.position,intakePose.heading)
...
//                        .stopAndAdd(readLift())
                        ...
                        .stopAndAdd(new InstantAction(() -> robot.deposit.goToPosition(DepositArm.PivotArmStates.TRASNFER)))
